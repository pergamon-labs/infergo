...
That is why the current alpha direction has two tracks:

- **family 1**
  - public alpha BYOM contract
- **family 2**
  - internal-first `entres` bridge

This keeps the repo useful to us without making the public story fuzzy.
