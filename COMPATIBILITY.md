...
Internal-first bridge only:

- numeric-feature TorchScript scorer for the `entres` use case
- experimental
- not part of the public alpha BYOM contract
...
| `torchscript` | Experimental, backend-specific, internal-first |
